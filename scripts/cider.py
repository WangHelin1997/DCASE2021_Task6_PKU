...
def cook_test(test, n=4):
    ...
    # return [precook(tst, n) for tst in test]
...
class CiderScorer(object):
    ...
    def __init__(self, test=None, refs=None, n=4, sigma=6.0,df=None):
        ...
        if df is not None:
            with open(df,"rb") as f:
                ...
                self.ref_len = np.log(float(self.ref_len))
    ...
    def cook_append(self, test, refs):
        ...
        if refs is not None:
            ...
            if test is not None:
                ...
                self.ctest.extend(None) # lens of crefs and ctest have to match
    ...
    def compute_doc_freq(self):
        ...
        for refs in self.crefs:
            ...
            for ngram in set([ngram  for (ngram,count) in refs.items()]):
                # print(ngram)
    ...
    def compute_cider(self):
        ...
        for test, refs in zip(self.ctest, self.crefs):
            ...
            # divide by number of referencesscores
            score_avg /= len(refs)
    ...
    def compute_score(self, option=None, verbose=0):
        ...
        # print(max(self.document_frequency.values()))
